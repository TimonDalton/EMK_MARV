...
; This is the pre-2026-05-14 version of marv_p3.s. Kept for reference only.
; The current P3 firmware lives in marv_p3.s (rebuilt from marv.s with the
; UART command menu wired into the existing state machine).
; =========================================================================
